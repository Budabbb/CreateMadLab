...
void main() {
    ...
    if (gl_Color.a != 0.4) {
        ...
        float om = cos(2.0 * PI * (frameTimeCounter / 5.50 + (worldpos.z) / 9999.0)) / 96.0 * fadeIntensity;
    ...
    if (gl_Color.a != 0.4) {
        ...
        float om = cos(2.0 * PI * (frameTimeCounter / 5.50 + (worldpos.x) / 9999.0)) / 96.0 * fadeIntensity;
