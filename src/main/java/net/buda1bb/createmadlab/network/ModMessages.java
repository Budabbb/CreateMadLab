...
public final class ModMessages {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(OpioidOverdoseEffectS2CPacket.TYPE, OpioidOverdoseEffectS2CPacket.STREAM_CODEC, OpioidOverdoseEffectS2CPacket::handle);
        registrar.playToClient(OpiateWithdrawalEffectS2CPacket.TYPE, OpiateWithdrawalEffectS2CPacket.STREAM_CODEC, OpiateWithdrawalEffectS2CPacket::handle);
        registrar.playToClient(DrugVisualStateS2CPacket.TYPE, DrugVisualStateS2CPacket.STREAM_CODEC, DrugVisualStateS2CPacket::handle);
    }
